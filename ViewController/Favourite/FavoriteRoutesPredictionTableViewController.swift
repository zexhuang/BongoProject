//
//  FavoriteRoutesPredictionTableViewController.swift
//  Bongo
//
...
class FavoriteRoutesPredictionTableViewController: UITableViewController {
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "FavoriteRoutesPredictionCell", for: indexPath) as! FavoriteRoutesPredictionTableViewCell
